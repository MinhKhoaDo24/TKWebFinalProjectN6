    $(document).ready(function () {
        ...
        // ==========================================
        // 2. LOGIC YÊU THÍCH (Sử dụng hàm từ auth.js)
        // ==========================================
        ...
        window.toggleFavorite = (e, id) => {
            ...
            // GỌI HÀM KIỂM TRA ĐĂNG NHẬP TỪ AUTH.JS
            ...
            if (favs.includes(id)) {
                ...
                btn.addClass('animate-wiggle'); 
                setTimeout(() => btn.removeClass('animate-wiggle'), 500);
            } else {
                favs.push(id);
        ...
        // ==========================================
        // 4. XỬ LÝ SỰ KIỆN GIAO DIỆN CHUNG
        // ==========================================
        ...
        // ==========================================
        // 5. FETCH DATA & RENDER (Giữ nguyên)
        // ==========================================
